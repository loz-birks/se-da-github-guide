---
title: "Using GitHub in Databricks"
---

# Aims

Many of the principles of working in a reproducible way and using GitHub for this also apply when we use GitHub in UDAL and Databricks. We will go through the practicalities of connecting to and using your GitHub account in Databricks.
...
::: callout-tip
Remember that you roll back commits, so feel free to stage your commits (make multiple smaller commits) to make it easier to roll back only what you need to.
:::
