...
::: callout-note
You can manage this process in GitHub desktop, VS Code, or wherever you are most comfortable.
:::

## within the regular QA process
...
Once you've been added as a reviewer, you will receive an email with a link, and a GitHub notification where you can view changes. Additions will be in green and removals in red. Review all changes and files, adding comments and requestion changes where necessary. Once you are happy with the changes and all issues are resolved, you can approve the pull request. 
...
## What to do if you spot an issue or have an idea
